...
from model.embedding import Team2Vec
import itertools
import keras
import glob
...
def pick_model_weights(model: keras.models.Model, dataset_name, path='Embeddings/Weights'):
    model_names = []
...
def load_T2V_model(model: Team2Vec, path='Embeddings/T2V'):
    model_names = []
...
def save_record(dict, dict_name, dir='embeddings/'):
