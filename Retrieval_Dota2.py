...
if __name__ == '__main__':
    ...
    parser.add_argument('-method_name', type=str, default="Dota2_128")
    ...
    for fold_counter in range(1, args.k_fold + 1):
        ...
        # Load dataset
        test_dataset = dblp.load_ae_dataset(file_path='ablation/Diffusion_Outputs/Dota2_128_45k.pkl')
        train_test_indices = dblp.load_train_test_indices(file_path='dataset/dota2/dota2_train_test_indices'
        '.pkl')
        _, _, x_test_skill, x_test_user = dblp.get_fold_data(fold_counter, test_dataset, train_test_indices)

        preprocessed_dataset = dblp.load_preprocessed_dataset(file_path='dataset/dota2/dota2_dataset.pkl')
    ...
    for file_name in file_names:
        ...
        eval_output_name = f"ablation/Metrics/{method_name}.csv"
